...
$sqlDate1 = 'SELECT mois, annee, montantValide, idEtat, id FROM FicheFrais WHERE idVisiteur='.$idVisiteur.' AND id='.$id.';';
                        ...
                        while($userData = $sqlDate1 -> fetch_assoc()) {
                            ...
                            echo '<tr>
                                ...
                                <td>'. $idEtat.'</td>
                                <td> <a href="delete.php?id='. $userData['id'] .'">  <img src="../img/poubelle.png" width=35px height=35px></a></td>
                       
                                <td> <a href="RenseignerFicheFraisModif.php?id='. $userData['id'] .'"><img src="../img/crayon.png" width=35px height=35px></a></td>
                       
                                <td> <a href="LireFicheFrais.php?id='. $userData['id'] .'"><img src="../img/oeil.png" width=35px height=35px></a></td>';
                        }
}
